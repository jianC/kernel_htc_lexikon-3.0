...
static struct flashlight_platform_data lexikon_flashlight_data_XA = {
        .gpio_init = config_lexikon_flashlight_gpios_XA,
        .torch = LEXIKON_GPIO_TORCH_EN,
        .flash = PM8058_GPIO_PM_TO_SYS(LEXIKON_GPIO_FLASH_EN),
        .flash_duration_ms = 600,
	    .led_count = 1,
};

static struct platform_device lexikon_flashlight_device_XA = {
        .name = "FLASHLIGHT_AAT1271",
        .dev = {
                .platform_data  = &lexikon_flashlight_data_XA,
        },
};

// ADP1650
static void config_lexikon_flashlight_gpios_XB(void)
{
	uint32_t flashlight_gpio_table[] = {
		PCOM_GPIO_CFG(LEXIKON_GPIO_FLASH_EN, 0, GPIO_OUTPUT,
						GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
...
static struct flashlight_platform_data lexikon_flashlight_data_XB = {
        .gpio_init = config_lexikon_flashlight_gpios_XB,
        .flash = PM8058_GPIO_PM_TO_SYS(LEXIKON_GPIO_FLASH_EN),
        .flash_duration_ms = 600,
	    .led_count = 1,
};

static struct i2c_board_info lexikon_flashlight_XB[] = {
{
	I2C_BOARD_INFO(FLASHLIGHT_NAME, 0x60 >> 1),
	.platform_data	= &lexikon_flashlight_data_XB,
	},
};
#endif
...
#ifdef CONFIG_ARCH_MSM_FLASHLIGHT
	if (system_rev == 0)
		platform_device_register(&lexikon_flashlight_device_XA);
	else
		i2c_register_board_info(0, lexikon_flashlight_XB,
			ARRAY_SIZE(lexikon_flashlight_XB));
#endif
